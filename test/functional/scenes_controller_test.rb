...
class ScenesControllerTest < ActionController::TestCase
  ...
  test "should create scene" do
    assert_difference('Scene.count') do
      post :create, scene: { custom_description: @scene.custom_description, order_index: @scene.order_index, project_id: @scene.project_id }
    end
  ...
  test "should update scene" do
    put :update, id: @scene, scene: { custom_description: @scene.custom_description, order_index: @scene.order_index, project_id: @scene.project_id }
    assert_redirected_to scene_path(assigns(:scene))
  end
